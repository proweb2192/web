        ...
        <div style="position:absolute; top:25px; left:140px; visibility:visible z-index:1">  
            ...
            <div class="navigation" >
                <ul class="menu">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="proctyservicios.php">Productos y Servicios</a>
                            <ul class="submenu">
                                <li>
                                    <a href="comercial.php">Papeleria Comercial</a>
                                </li>
                                <li>
                                    <a href="miscelanea.php">Miscelanea</a>
                                </li>   
                            </ul>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="acerca_de.php">Nosotros </a>
                            <ul class="submenu">
                                <li>
